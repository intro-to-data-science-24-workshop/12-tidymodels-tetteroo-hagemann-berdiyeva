...
| **mae()**                 | Mean Absolute Error           | 0 < x < 1, the lower the better     |
| mape()                | Mean Absolute Percentage Error | 0 < x < 1, the lower the better    |
| msd()                 | Mean Squared Deviation        | 0 < x < 1, the lower the better     |
| poisson_log_loss()    | Poisson Log Loss              | 0 < x < 1, the lower the better     |
| **rmse()**                | Root Mean Squared Error       | 0 < x < 1, the lower the better     |
