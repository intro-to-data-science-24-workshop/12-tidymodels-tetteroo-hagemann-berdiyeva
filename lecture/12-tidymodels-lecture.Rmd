...
1. [Tidymodels: A brief overview](#Tidymodels: A brief overview)<sup>1</sup>
...
5. [Yardstick](#Yardstick)

6. [Example and Exercise](#ex and ex)

7. [For further investigation](#other)

---
name: Tidymodels: A brief overview
- Tidymodels encompasses a large range of packages, each targeted at a specific part of the modelling process. Graphically: 


---
#The different packages:
Goal of each package:
1. rsamples - to split the data into training and testing, analysis and assessment sets 
2. recipes - to prepare the data with preprocessing 
...
6. tune and dials - to optomise models  
7. broom - to increase the readability of model output

For other great overviews of how the packages complement eachother and fit within the whole modelling process, click [here]{https://rpubs.com/chenx/tidymodels_tutorial}
...
---
Name: Sources and Other resources
# Further Ressources
